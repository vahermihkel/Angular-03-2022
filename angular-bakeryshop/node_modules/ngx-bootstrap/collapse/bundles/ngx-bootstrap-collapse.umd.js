(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/collapse', ['exports', '@angular/animations', '@angular/core','@angular/core'], factory) :
...
CollapseDirective.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CollapseDirective, selectors: [["", "collapse", ""]], factory: function CollapseDirective_Factory(t) { return new (t || CollapseDirective)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.Renderer2), ɵngcc0.ɵɵdirectiveInject(animations.AnimationBuilder)); }, hostBindings: function CollapseDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CollapseDirective, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: core.Renderer2 }, { type: animations.AnimationBuilder }]; }, { _el: [], _renderer: [], collapsed: [{
            type: core.Output
        }], collapses: [{
            type: core.Output
        }], expanded: [{
...
CollapseModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: CollapseModule });
...
CollapseModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function CollapseModule_Factory(t) { return new (t || CollapseModule)(); } });
