...
export declare class BsMonthCalendarViewComponent {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<BsMonthCalendarViewComponent, "bs-month-calendar-view", never, { 'calendar': "calendar" }, { 'onNavigate': "onNavigate", 'onViewMode': "onViewMode", 'onSelect': "onSelect", 'onHover': "onHover" }, never>;
}
