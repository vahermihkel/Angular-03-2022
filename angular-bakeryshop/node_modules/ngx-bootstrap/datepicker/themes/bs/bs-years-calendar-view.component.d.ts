...
export declare class BsYearsCalendarViewComponent {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<BsYearsCalendarViewComponent, "bs-years-calendar-view", never, { 'calendar': "calendar" }, { 'onNavigate': "onNavigate", 'onViewMode': "onViewMode", 'onSelect': "onSelect", 'onHover': "onHover" }, never>;
}
