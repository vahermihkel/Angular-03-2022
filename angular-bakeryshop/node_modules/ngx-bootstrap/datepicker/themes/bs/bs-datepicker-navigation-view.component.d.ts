...
export declare class BsDatepickerNavigationViewComponent {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<BsDatepickerNavigationViewComponent, "bs-datepicker-navigation-view", never, { 'calendar': "calendar" }, { 'onNavigate': "onNavigate", 'onViewMode': "onViewMode" }, never>;
}
