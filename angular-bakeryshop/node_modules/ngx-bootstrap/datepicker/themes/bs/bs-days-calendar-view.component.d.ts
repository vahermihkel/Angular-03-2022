...
export declare class BsDaysCalendarViewComponent {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<BsDaysCalendarViewComponent, "bs-days-calendar-view", never, { 'calendar': "calendar", 'options': "options" }, { 'onNavigate': "onNavigate", 'onViewMode': "onViewMode", 'onSelect': "onSelect", 'onHover': "onHover", 'onHoverWeek': "onHoverWeek" }, never>;
}
