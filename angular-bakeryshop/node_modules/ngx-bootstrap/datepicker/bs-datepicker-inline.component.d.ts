...
export declare class BsDatepickerInlineDirective implements OnInit, OnDestroy, OnChanges {
    ...
    setConfig(): void;
    ngOnDestroy(): any;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<BsDatepickerInlineDirective, "bs-datepicker-inline", ["bsDatepickerInline"], { 'bsValue': "bsValue", 'bsConfig': "bsConfig", 'isDisabled': "isDisabled", 'minDate': "minDate", 'maxDate': "maxDate", 'dateCustomClasses': "dateCustomClasses", 'datesDisabled': "datesDisabled" }, { 'bsValueChange': "bsValueChange" }, never>;
}
