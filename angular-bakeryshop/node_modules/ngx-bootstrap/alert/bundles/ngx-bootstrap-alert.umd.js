(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/alert', ['exports', '@angular/core', 'ngx-bootstrap/utils', '@angular/common','@angular/core','@angular/common'], factory) :
...
function AlertComponent_ng_template_0_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function AlertComponent_ng_template_0_ng_template_1_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r24); const ctx_r23 = ɵngcc0.ɵɵnextContext(2); return ctx_r23.close(); });
...
function AlertComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMap("alert alert-" + ctx_r21.type);
    ɵngcc0.ɵɵstylingApply();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r21.classes);
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r21.dismissible);
} }
const _c5 = ["*"];
'use strict';
...
AlertConfig.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AlertConfig, factory: function AlertConfig_Factory(t) { return new (t || AlertConfig)(); }, providedIn: null });
...
AlertComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: AlertComponent, selectors: [["alert"], ["bs-alert"]], factory: function AlertComponent_Factory(t) { return new (t || AlertComponent)(ɵngcc0.ɵɵdirectiveInject(AlertConfig), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef)); }, inputs: { type: "type", dismissible: "dismissible", isOpen: "isOpen", dismissOnTimeout: "dismissOnTimeout" }, outputs: { onClose: "onClose", onClosed: "onClosed" }, ngContentSelectors: _c5, consts: 1, vars: 1, template: function AlertComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AlertComponent, [{
    ...
    }], function () { return [{ type: AlertConfig }, { type: core.ChangeDetectorRef }]; }, { changeDetection: [], type: [{
            type: core.Input
        }], dismissible: [{
            type: core.Input
        }], isOpen: [{
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(AlertModule, { declarations: [AlertComponent], imports: [ɵngcc1.CommonModule], exports: [AlertComponent] });
...
AlertModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function AlertModule_Factory(t) { return new (t || AlertModule)(); }, imports: [[common.CommonModule]] });
        return AlertModule;
    }());
