(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-bootstrap/utils'), require('ngx-bootstrap/positioning'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/component-loader', ['exports', '@angular/core', 'ngx-bootstrap/utils', 'ngx-bootstrap/positioning','@angular/core'], factory) :
...
}(this, function (exports, core, utils, positioning,ɵngcc0) { 'use strict';
...
ComponentLoaderFactory.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ComponentLoaderFactory, factory: function ComponentLoaderFactory_Factory(t) { return new (t || ComponentLoaderFactory)(ɵngcc0.ɵɵinject(core.ComponentFactoryResolver), ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(core.Injector), ɵngcc0.ɵɵinject(positioning.PositioningService), ɵngcc0.ɵɵinject(core.ApplicationRef)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ComponentLoaderFactory, [{
        type: core.Injectable
    }], function () { return [{ type: core.ComponentFactoryResolver }, { type: core.NgZone }, { type: core.Injector }, { type: positioning.PositioningService }, { type: core.ApplicationRef }]; }, { _componentFactoryResolver: [], _ngZone: [], _injector: [], _posService: [], _applicationRef: [], createLoader: [] });
