...
export declare class ModalDirective implements OnDestroy, OnInit {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<ModalDirective, "[bsModal]", ["bs-modal"], { 'config': "config" }, { 'onShow': "onShow", 'onShown': "onShown", 'onHide': "onHide", 'onHidden': "onHidden" }, never>;
}
