(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-bootstrap/utils'), require('ngx-bootstrap/component-loader'), require('ngx-bootstrap/positioning'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/modal', ['exports', '@angular/core', 'ngx-bootstrap/utils', 'ngx-bootstrap/component-loader', 'ngx-bootstrap/positioning','@angular/core'], factory) :
...
}(this, function (exports, core, utils, componentLoader, positioning,ɵngcc0) { 
const _c0 = ["role", "dialog", "tabindex", "-1", 1, "modal"];
const _c1 = ["role", "document"];
const _c2 = [1, "modal-content"];
const _c3 = ["*"];
const _c4 = [1, "modal-backdrop"];
'use strict';
...
BsModalRef.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: BsModalRef, factory: function BsModalRef_Factory(t) { return new (t || BsModalRef)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BsModalRef, [{
        type: core.Injectable
    }], function () { return []; }, { hide: [], setClass: [] });
        return BsModalRef;
    }());
...
ModalContainerComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: ModalContainerComponent, selectors: [["modal-container"]], factory: function ModalContainerComponent_Factory(t) { return new (t || ModalContainerComponent)(ɵngcc0.ɵɵdirectiveInject(ModalOptions), ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.Renderer2)); }, hostBindings: function ModalContainerComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ModalContainerComponent, [{
    ...
    }], function () { return [{ type: ModalOptions }, { type: core.ElementRef }, { type: core.Renderer2 }]; }, { _element: [], _renderer: [], isShown: [], isModalHiding: [], config: [], ngOnInit: [], onClick: [{
...
ModalBackdropComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: ModalBackdropComponent, selectors: [["bs-modal-backdrop"]], factory: function ModalBackdropComponent_Factory(t) { return new (t || ModalBackdropComponent)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.Renderer2)); }, hostBindings: function ModalBackdropComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ModalBackdropComponent, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: core.Renderer2 }]; }, { _isShown: [], element: [], renderer: [], isAnimated: [], isAnimated: [], isShown: [], isShown: [], ngOnInit: [] });
...
ModalDirective.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: ModalDirective, selectors: [["", "bsModal", ""]], factory: function ModalDirective_Factory(t) { return new (t || ModalDirective)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(core.Renderer2), ɵngcc0.ɵɵdirectiveInject(componentLoader.ComponentLoaderFactory)); }, hostBindings: function ModalDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ModalDirective, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: core.ViewContainerRef }, { type: core.Renderer2 }, { type: componentLoader.ComponentLoaderFactory }]; }, { _element: [], _renderer: [], onShow: [{
            type: core.Output
        }], onShown: [{
            type: core.Output
        }], onHide: [{
            ...
            type: core.Input
        }], config: [], isShown: [], onClick: [{
            type: core.HostListener,
            args: ['click', ['$event']]
        }], dismissReason: [], onEsc: [{
            type: core.HostListener,
            args: ['keydown.esc', ['$event']]
        }], ngOnDestroy: [], ngOnInit: [], _config: [], toggle: [], show: [], hide: [], getConfig: [], showElement: [], hideModal: [], showBackdrop: [], backdrop: [], removeBackdrop: [], focusOtherModal: [], resetAdjustments: [], checkScrollbar: [], setScrollbar: [], resetScrollbar: [], getScrollbarWidth: [] });
...
ModalModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: ModalModule });
...
ModalModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ModalModule_Factory(t) { return new (t || ModalModule)(); } });
        return ModalModule;
    }());
