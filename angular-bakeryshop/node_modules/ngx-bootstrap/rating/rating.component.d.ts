...
export declare class RatingComponent implements ControlValueAccessor, OnInit {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<RatingComponent, "rating", never, { 'max': "max", 'titles': "titles", 'readonly': "readonly", 'customTemplate': "customTemplate" }, { 'onHover': "onHover", 'onLeave': "onLeave" }, never>;
}
